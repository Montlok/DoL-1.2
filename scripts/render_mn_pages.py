...
def _to_presentation(text: str) -> str:
    ...
    The corpus's nominal form (see Encoding Mapping/README) collapses the
    historical NNBSP suffix separator into MVS (U+180E), but real-world fonts
    (Onon, Menksoft, GB/T 25914) key their suffix shaping on NNBSP (U+202F).
